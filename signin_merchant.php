...
?>
                ...
                <!-- <script>alert("Store details already Set with Current User")
                location.replace("http://localhost/kwykpr/ordermanage.php");
                </script> -->
            <?php
            }
            else if($s_status=="Pending"){
                 
                echo '<script> swal({title: "Your Application is under Processing!!",});</script>'; 
            }
            else{
               echo '<script> swal({title: "Your application is Rejected!!",});</script>'; 
            }
...
?>
            <script>
                swal({
                    title:"Fill the store Details to create your ONLINE Store!!"})
                    .then((value) => {
...
<!-- <img src="bg.jpg" class="main" height="715vh" width="100%" alt=""> -->
  <div class="container">
  <img src="logo.png" alt="KWYK Logo" class="logo" style="position: absolute;left: 3%;top: 5%;width: 125px;height: 90px;">
    <div class="row">
        <div class="col-md-12">
            <!-- <div class="modal-box"> -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content clearfix">
                            ...
                            <div class="modal-body">
                                ...
                                <p style="margin-top: 20px;">Not have an account? <a href="signup_merchant.php">Signup</a></p>
                            </div>
