...
if(isset($_POST['submit']))
{
    ...
    if($emailcount>0 ){
       ...
       <script>
                swal({
                    icon: "error",
                    title: "Email already exists Please enter another Email!",
        ...
        if($iquery)
        {
            ...
            <script>
                swal({
                 ...
                 location.replace("http://localhost/kwykpr/signin_merchant.php");
            </script>
            <?php
        }
        else
                        ...
                        <div class="modal-content clearfix">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group " style="font-size:14px;">
                                    ...
                                    <label> &nbsp;I agree 
                                    <a  href="https://www.kwyk.store/terms-and-conditions">Terms and Privacy-policy</a></label>
...
// });
     ...
     -->
                                ...
                                <p style="margin-top: 20px;">Already have an account? <a href="signin_merchant.php">Sign in</a></p>
                            </div>
