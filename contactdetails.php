            ...
            <!-- <div class="space1 col-md-9"> -->
                ...
                <div class="space1 col-md-9" style="overflow :scroll; overflow-x: hidden; height:700px; width:100%;">
                    <?php 
                        ...
                        if(isset($row['oname']) && !empty ($row['oname'])){
                    ?>
        <div class="col-md-12">                    
...
<script>
                    ...
                    <?php 
                    if(isset($_POST['Next'])){
                        echo '<script>location.replace("http://localhost/kwykpr/shopconfig.php");</script>';
                    }
                    ...
                    if($run){?>
                        '<script>
                            ...
                            .then((value) => {
                                swal(location.replace("http://localhost/kwykpr/contactdetails.php"));
                            });
                                </script>'
                    <?php 
                        ...
                        <script>swal({
                            icon: "danger",
                            title: "Contact Details not Updated",
                            });
                            </script>
                    <?php
                }
...
<script>
    ...
    if(isset($_POST['save'])){
      ...
      if($run){
          ...
          echo '<script>swal({
            icon: "danger",
            title: "Contact Details not Saved",
            });
            </script>';
      }
