...
<head>
    ...
    <link rel="stylesheet" href="/kwykpr/storedetails.css">
    <link rel="stylesheet" href="/kwykpr/setstore.css">
            ...
            <!-- <div class="space1 col-md-9"> -->
                ...
                <!-- <option value="<?php echo $bizcat_row['category_id'] ?>"><?php echo $bizcat_row["category_type"] ?></option>; -->
                  ...
                  ?>         
                            ...
                            <div style="margin: 20px;" class="form-row">
                                ...
                                <div class="form-group col-md-6" style="margin-bottom:5px;">
                                    <label for="formFile" class="form-label">Background Image (jpeg/png/jpg)</label>
                    ...
                    //Validation of user name
                        ...
                        if (ssname==false) 
                        {
                            ...
                            document.getElementById('ssname').innerHTML="Please enter shop name";
                            return false;
                        ...
                        if (shopurl==false) 
                        {
                        ...
                        else
                            {
                                document.getElementById('shopurl').innerHTML="";
                                            ...
                                            <?php
                        // if(isset($_POST['Next'])){
                        //     echo '<script>location.replace("http://localhost/kwykpr/admin/admin_uploaddocs.php");</script>';
                        // } 
                    ...
                    $delbaner = addslashes(file_get_contents($_FILES["delbaner"]["tmp_name"]));
                        ...
                        if($run){?>
                            ...
                            .then((value) => {
                                swal(location.replace("http://localhost/kwykpr/admin/admin_setstore.php?reject=<?= $row_order['shop_id'];?>"));
                            });
                                </script>;
                        <?php 
                ...
                <option value="<?php echo $bizcat_row['category_id'] ?>"><?php echo $bizcat_row["category_type"] ?></option>;
                  ...
                  ?>
                                ...
                                <p id="p">selectedIndex: 0</p><br><br>
        ...
        if($run){?>
            <script>
                            ...
                            swal({
                                ...
                                title:"Record updated!"})
                            .then((value) => {
                                swal(location.replace("http://localhost/kwykpr/admin/admin_uploaddocs.php"));
                            });
                                </script>
        <?php 
        } 
