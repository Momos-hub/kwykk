...
<head>
    ...
    <link rel="stylesheet" href="/kwykpr/uploaddoc.css">
  ...
  opacity: 1;
        ...
        <div style="width:300px;height:100%; border-right: 1px solid rgba(0,0,0,.1); height: calc(100vh - 90px);">
            ...
            <h4 align="center" style="margin-top:5px;"><b>Update Uploaded Documents</b></h4>
                ...
                <?php
                        // if(isset($_POST['Next'])){
                        //     echo '<script>location.replace("http://localhost/kwykpr/admin/admin_bankdetail.php");</script>';
                        // } 
                        ...
                        if(isset($_POST['update']))
                    {
                        ...
                        if($run){?>
                            ...
                            swal({
                                ...
                                title:"Record updated!"})
                            .then((value) => {
                                swal(location.replace("http://localhost/kwykpr/admin/admin_bankdetail.php"));
                            });
                                </script>'
                        <?php 
...
if(isset($_POST['next'])){
    ...
    if(isset($_POST['upload'])){
        ...
        if($run){
            ...
            swal("Record Saved!")
            .then((value) => {
                swal(location.replace("http://localhost/kwykpr/admin/admin_uploaddoc.php"));
            });
                </script>';
        }
        else{
